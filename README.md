# 🐞 BugCo Industries – Java Debugging Challenge Tool
...
BugCo is a **debugging puzzle tool** where players take on coding challenges by finding and correcting faulty Java code. Each challenge rewards points based on its complexity, and performance is tracked on a **dynamic leaderboard**. Perfect for learners and enthusiasts looking to sharpen their Java skills!
...
> **Note**: This app is packaged as an executable `.jar` file (or `.exe` if wrapped).
